  ...
  return (
    <section className="min-h-screen bg-white px-6 md:px-12 lg:px-16 py-16 md:py-20 flex flex-col justify-between">
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="bg-[#f4efe6] border border-[#b8a66a]/20 rounded-lg p-4 md:p-6 shadow-sm">
          <img
            src="/images/charts/capital-systems-market-regimes.png"
            alt="Capital Systems Across Market Regimes"
            className="w-full h-auto rounded-md"
          />
          <p className="mt-4 font-['Inter'] text-sm text-[#1a1a1a]/60 text-center">
            Different capital engines lead in different market environments.
        ...
        <div className="mt-10 border-t border-[#1a1a1a]/10 pt-8">
          <p className="font-['Inter'] text-base md:text-lg text-[#1a1a1a]/70 leading-relaxed">
            The goal is not more holdings. It is fewer single points of
            failure.
          </p>
        </div>
      </div>
