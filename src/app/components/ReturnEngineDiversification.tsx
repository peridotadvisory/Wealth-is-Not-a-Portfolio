  ...
  return (
    <div className="min-h-screen bg-white px-8 py-24">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Comparison Chart */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 bg-[#e8e2d4] p-12 rounded-lg">
          {/* Portfolio Only */}
          <div>
            <h3 className="font-['Playfair_Display'] text-2xl text-[#1a1a1a] mb-8 text-center">
              Portfolio Only
            </h3>
              ...
              {portfolioData.map((item, index) => (
                <div key={item.source}>
                  <div className="flex justify-between mb-1">
                    <span className="font-['Inter'] text-sm text-[#1a1a1a]">{item.source}</span>
                    <span className="font-['Inter'] text-sm text-[#1a1a1a]/60">{item.value}%</span>
                  </div>
            ...
            <div className="bg-white p-4 rounded">
              <p className="font-['Inter'] text-sm text-[#1a1a1a] text-center">
