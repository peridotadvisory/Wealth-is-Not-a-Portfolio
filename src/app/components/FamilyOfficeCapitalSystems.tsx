  ...
  return (
    <div className="min-h-screen bg-white px-6 md:px-12 py-16 md:py-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-16">
          <p className="font-['Inter'] text-xl md:text-2xl text-[#1a1a1a] leading-relaxed max-w-4xl mx-auto text-center mb-16">
              ...
              {engines.map((engine, index) => (
                <g key={engine.name}>
                  ...
                  <text
                    ...
                    className="font-['Inter'] text-[16px] md:text-[18px] fill-[#1a1a1a]"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="space-y-4">
              <h3 className="font-['Inter'] font-medium text-lg md:text-xl text-[#1a1a1a] mb-3">
                Enterprise Capital
              </h3>
        ...
        {/* Callout */}
        <div className="border-l-4 border-[#b8a66a] pl-6 md:pl-8 mt-16 max-w-3xl mx-auto">
          <p className="font-['Playfair_Display'] text-xl md:text-2xl text-[#1a1a1a] italic leading-relaxed">
