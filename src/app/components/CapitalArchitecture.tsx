  ...
  return (
    <div className="min-h-screen bg-white px-6 md:px-12 py-16 md:py-24">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Modular Diagram */}
        <div className="bg-[#e8e2d4] p-8 md:p-12 rounded-lg">
          <svg viewBox="0 0 1200 600" className="w-full">
            {/* Central System Hub */}
            <rect x="500" y="250" width="200" height="100" fill="white" stroke="#1a1a1a" strokeWidth="2" />
            <text x="600" y="290" textAnchor="middle" className="font-['Inter'] text-[16px] md:text-[18px] fill-[#1a1a1a]">
              Capital System
            </text>
            <text x="600" y="310" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#1a1a1a]/60">
              (Orchestration Layer)
            </text>
            ...
            <text x="175" y="85" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Enterprise
            </text>
            <text x="175" y="105" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Capital
            </text>
            ...
            <text x="1025" y="85" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Market
            </text>
            <text x="1025" y="105" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Capital
            </text>
            ...
            <text x="125" y="295" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Structural
            </text>
            <text x="125" y="315" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Capital
            </text>
            ...
            <text x="1075" y="295" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Income
            </text>
            <text x="1075" y="315" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Engines
            </text>
            ...
            <text x="175" y="505" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Credit
            </text>
            <text x="175" y="525" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Strategies
            </text>
            ...
            <text x="1025" y="505" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Liquidity
            </text>
            <text x="1025" y="525" textAnchor="middle" className="font-['Inter'] text-[14px] md:text-[16px] fill-[#f4efe6]">
              Reserves
            </text>
          ...
          <p className="font-['Inter'] text-sm md:text-base text-[#1a1a1a]/70 text-center mt-8 max-w-3xl mx-auto">
