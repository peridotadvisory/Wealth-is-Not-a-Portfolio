  ...
  return (
    <div className="h-screen relative flex flex-col items-center justify-center overflow-hidden bg-[#0f2e26]">
      ...
      <div className="relative z-10 text-center px-8 max-w-4xl">
        <h1 className="font-['Playfair_Display'] text-6xl md:text-7xl lg:text-8xl text-[#e8e2d4] mb-6 tracking-wide">
        ...
        <div className="border-t border-[#b8a66a]/30 pt-8 mt-16">
          <p className="font-['Inter'] text-lg text-[#e8e2d4]/80 mb-4">
            Peridot Advisory
          </p>
      ...
      <div className="absolute bottom-12 left-0 right-0 text-center px-8">
        <p className="font-['Inter'] text-sm md:text-base text-[#e8e2d4]/60 italic max-w-2xl mx-auto">
