  ...
  return (
    <section className="min-h-screen bg-white px-6 md:px-12 lg:px-16 py-16 md:py-20 flex flex-col justify-between">
      <div className="max-w-7xl mx-auto w-full">
        <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl lg:text-6xl text-[#1a1a1a] mb-10">
          Market Fragility
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {crises.map((crisis) => (
            <div
              key={crisis.year}
              className="bg-[#f4efe6] border border-[#b8a66a]/15 rounded-lg p-6"
            >
              <p className="font-['Inter'] text-sm uppercase tracking-[0.14em] text-[#b8a66a] mb-3">
                {crisis.year}
              </p>
