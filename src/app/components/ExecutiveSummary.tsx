  ...
  return (
    <section className="min-h-screen bg-[#f4efe6] px-6 md:px-12 lg:px-16 py-16 md:py-20 flex flex-col justify-between">
      <div className="max-w-7xl mx-auto w-full">
        <div className="mb-12">
          <h2 className="font-['Playfair_Display'] text-4xl md:text-5xl lg:text-6xl text-[#0f2e26] mb-8">
            Executive Summary
          </h2>
        </div>
        ...
        <div className="max-w-4xl border-l-4 border-[#b8a66a] bg-white/40 px-6 md:px-8 py-6">
