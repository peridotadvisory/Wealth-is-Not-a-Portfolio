      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {insights.map((insight, index) => (
            <div key={index} className="bg-[#e8e2d4] p-8 rounded-lg">
              <div className="flex items-start gap-4">
                <div className="text-4xl flex-shrink-0">{insight.icon}</div>
                <div>
                  <h3 className="font-['Playfair_Display'] text-2xl text-[#1a1a1a] mb-3">
                    {insight.title}
                  </h3>
        ...
        {/* Summary Points */}
        <div className="bg-[#0f2e26] p-12 rounded-lg mb-16">
          <h3 className="font-['Playfair_Display'] text-3xl text-[#e8e2d4] mb-8 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="font-['Inter'] text-sm text-[#e8e2d4]/90 leading-relaxed">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <p className="font-['Playfair_Display'] text-2xl text-[#1a1a1a] leading-relaxed italic mb-6">
