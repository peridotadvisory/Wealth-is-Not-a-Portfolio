export function TableOfContents() {
  const contents = [
    ...
    { section: "07", title: "Capital Architecture", page: 9 },
    { section: "08", title: "Return Engine Diversification", page: 10 },
    { section: "09", title: "Competitive Returns Without Fragility", page: 11 },
    { section: "10", title: "Implications for Entrepreneurs", page: 12 },
    { section: "11", title: "Key Insights", page: 13 },
    { section: "12", title: "Conclusion", page: 14 },
  ];
        ...
        <div className="space-y-6">
          {contents.map((item) => (
            <div key={item.section} className="flex items-baseline border-b border-[#e8e2d4] pb-3">
              ...
              <span className="font-['Inter'] text-lg text-[#1a1a1a] flex-1">
                {item.title}
              </span>
