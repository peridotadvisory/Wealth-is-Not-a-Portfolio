  ...
  return (
    <div className="min-h-screen bg-white px-8 py-24">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Transition Diagram */}
        <div className="bg-[#e8e2d4] p-12 rounded-lg mb-16">
          ...
          <div className="flex items-center justify-center gap-8">
            ...
            <div className="flex-1 max-w-xs">
              <div className="bg-[#0f2e26] p-8 rounded-lg text-center mb-4">
                <div className="font-['Playfair_Display'] text-2xl text-[#e8e2d4] mb-2">
                  Phase I
                </div>
                <div className="font-['Inter'] text-sm text-[#b8a66a]">
                  Operating Business
                </div>
              </div>
              <p className="font-['Inter'] text-xs text-[#1a1a1a]/70 text-center">
            ...
            <div className="flex-1 max-w-xs">
              <div className="bg-[#b8a66a] p-8 rounded-lg text-center mb-4">
                <div className="font-['Playfair_Display'] text-2xl text-[#1a1a1a] mb-2">
                  Phase III
                </div>
                <div className="font-['Inter'] text-sm text-[#1a1a1a]">
                  Capital System
                </div>
              </div>
              <p className="font-['Inter'] text-xs text-[#1a1a1a]/70 text-center">
        ...
        {/* Key Insight */}
        <div className="border-l-4 border-[#b8a66a] pl-8 max-w-4xl mx-auto">
          <p className="font-['Inter'] text-lg text-[#1a1a1a] leading-relaxed mb-4">
